...
<script>
  function bill_search_submit(){
    document.getElementById('bill_report').action='bill_search.php';
		document.getElementById('bill_report').submit();

  }

  function excelDownLoad(){
    document.getElementById('bill_report').action='bill_search_display_xls.php';
		document.getElementById('bill_report').submit();
            ...
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr>
                  <td width="25%"><h3>Bill Search :</h3></td>
              ...
              <?php include("bill_search_display.php"); ?>   
              <?php }  } ?>           
            </div>                                 
          </td>
        </tr>
