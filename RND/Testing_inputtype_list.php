...
<script>
  ...
  function report_submit(){
    ...
    //if(check()){
      document.getElementById('report').action='Testing_inputtype_list.php';
          ...
          <select onchange='downloadLock()' name="buyer_account_code" id="buyer_account_code">
              <option value="">All</option>
                ...
                ?>
                  ...
                  <td>
                  <input type='text' list="supplier" name="supplier_account_code" id="supplier_account_code">
                        ...
                        <option value="">All</option>
                          <?php
                            ...
                            while($s_rs=mysqli_fetch_array($s_result))
                            {
                              ...
                              echo "<option $selected data-value='".$s_rs['company_id']."'>".$s_rs['firm_name']."</option>";
                            }
                          ?>
                          </datalist>
                    <!-- </select> -->
