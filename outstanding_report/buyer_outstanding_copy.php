...
<script>
  ...
  function report_submit(){
    ...
    //if(check()){
      document.getElementById('report').action='buyer_outstanding_copy.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){
        document.getElementById('report').action='buyer_outstanding_report_display_xls_copy.php';
        document.getElementById('report').target="_self";
      //  document.getElementById('report').onsubmit="";
        document.getElementById('report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('report').action='buyer_outstanding_report_display_print_copy.php';
    ...
    <td height="326" valign="top">
      ...
      <td>
          <select onchange='downloadLock()' name="buyer_account_code" id="buyer_account_code">
              ...
              <?php include("buyer_outstanding_report_display_copy.php"); ?>   
              <?php } ?>           
            </div>                                 
          </td>
        </tr>
