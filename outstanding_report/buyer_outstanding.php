...
<script>
  ...
  function report_submit(){
    ...
    //if(check()){
      document.getElementById('report').action='buyer_outstanding.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){
        document.getElementById('report').action='buyer_outstanding_report_display_xls.php';
        document.getElementById('report').target="_self";
      //  document.getElementById('report').onsubmit="";
        document.getElementById('report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('report').action='buyer_outstanding_report_display_print.php';
          ...
          <td valign="top">
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr><td><h3>Buyer Outstanding :</h3></td></tr></table>
              </div>
          ...
          <select onchange='downloadLock()' name="buyer_account_code" id="buyer_account_code">
              <option value="">All</option>
                ...
                <tr>
                  ...
                  <th align="left"> Display Discount </th>
                  
                  <td colspan='3'> 

                  <select name="disp_dis" id="disp_dis" onchange='downloadLock()'  >
                          ...
                          $disp_dis_arr=array('No','Yes');
                    
                          foreach($disp_dis_arr as $v)
                          {
                          $selected="";
