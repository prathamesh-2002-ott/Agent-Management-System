...
header ( "Content-Disposition: attachment; filename=Commission_summary_report_".$start_date."_To_".$end_date."_ason_".$date.".xls" );
?>

<?php  if($_REQUEST['bill_report_disp']=='OK'){ $rep_print=""; ?>      
<table ><tr><td>
