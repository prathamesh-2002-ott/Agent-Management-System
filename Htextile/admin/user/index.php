...
<tr>
  ...
  <tr>
    <td height="326" valign="top"><table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
           ...
           <!--  <td align="right"><button onclick="location.href='index_all.php'">ALL User</button></td>-->
              <td align="right"><button onclick="location.href='add_user.php'">Add User</button></td>
              </tr>
              </table>
              </div>

               <div id="accordion" style="width:95%; padding:20px;">
               	<?php 
					foreach($user_type_ar as $key=>$value) {
				?>	
              		<div>
						<h3><a href="#"><?php echo $value; ?></a></h3>
 ...
 <!--  <th>Delete</th> -->
    ...
    <?php
    $con=get_connection();
    $sql="select * from txt_login where login_type='$key'";
