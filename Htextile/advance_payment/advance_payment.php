...
<script>
  function report_submit(){
    document.getElementById('report').action='advance_payment.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
      document.getElementById('report').action='advance_payment_report_display_xls.php';
      document.getElementById('report').target="_self";
      document.getElementById('report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('report').action='advance_payment_report_display_print.php';
          ...
          <td valign="top">
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr><td><h3>Advance Payment Report :</h3></td></tr></table>
              </div>
          ...
          <select onchange='downloadLock()' name="buyer_account_code" id="buyer_account_code">
              <option value="">All</option>
                ...
                <tr>
                  ...
                  <td><input type="text" onChange="validatedate_format(this);downloadLock()"  name="end_date" class="datepick" size="8" id="end_date" value="<?php echo $disp_end_date ?>" />&nbsp;&nbsp; <input  type="button" class="date-button" onclick="changeDates()" name="changeDate" id="changeDate" value="Previous Year" /></td>
                </tr>
              ...
              <?php include("advance_payment_report_display.php"); ?>   
              <?php }  }?>           
            </div>                                 
          </td>
        </tr>
