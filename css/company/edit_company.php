...
?>
    ...
    <tr>
        ...
        <td width="244"><input name="firm_name" type="text" id="firm_name" value="<?php echo $rs['firm_name']; ?>" size="60"></td>
    </tr>
    <tr>
    	<th align="left">Address <span class="astrik">*</span></th>
        <td><input type="text" name="address" id="address" size="60" value="<?php echo $rs['address']; ?>"></td>
    </tr>
    <tr>
    	<th align="left">City <span class="astrik">*</span></th>
        <td><input type="text" name="city" id="city" value="<?php echo $rs['city']; ?>"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="pincode" id="pincode" size="8" value="<?php echo $rs['pincode']; ?>" onkeypress="return isNumberKey(event)" onInput="checkLength(6,this)" onblur="getChassis(this.value)"></td>
    </tr>
    <tr>
    	<th align="left">GSTIN <span class="astrik">*</span></th>
        <td><input type="text" name="gstin" id="gstin" size="20" value="<?php echo $rs['gstin']; ?>"></td>
	</tr>
	<tr>
    	<th align="left">Office Number</th>
        <td><input type="text" name="office_phone" id="office_phone" size="12" value="<?php echo $rs['office_phone']; ?>" onkeypress="return isNumberKey(event)" onInput="checkLength(12,this)" onblur="getChassis(this.value)"></td>
    </tr>
    <tr>
    	<th align="left">Contact Person</th>
        <td><input name="contact_person" type="text" id="contact_person" value="<?php echo $rs['contact_person']; ?>" size="40"></td>
    </tr>
    <tr>
    	<th align="left">Contact Number</th>
        <td><input type="text" name="contact_number" id="contact_number" size="12" value="<?php echo $rs['contact_number']; ?>" onkeypress="return isNumberKey(event)" onInput="checkLength(12,this)" onblur="getChassis(this.value)"></td>
    </tr>
    <tr>
    	<th align="left">Contact Person </th>
        <td><input name="contact_person_2" type="text" id="contact_person_2" value="<?php echo $rs['contact_person_2']; ?>" size="40"></td>
    </tr>
    <tr>
    	<th align="left">Contact Number</th>
		<td><input type="text" name="contact_number_2" id="contact_number_2" size="12" value="<?php echo $rs['contact_number_2']; ?>" onkeypress="return isNumberKey(event)" onInput="checkLength(12,this)" onblur="getChassis(this.value)"></td>
    </tr>

    <tr>
    	<th align="left">SMS Number</th>
        <td><input type="text" name="sms_number" id="sms_number" size="12" value="<?php echo $rs['sms_number']; ?>" onkeypress="return isNumberKey(event)" onInput="checkLength(12,this)" onblur="getChassis(this.value)"></td>
    </tr>
    <tr>
    	<th align="left">Whatsapp Number</th>
        <td><input type="text" name="whatsapp_number" id="whatsapp_number" size="12" value="<?php echo $rs['whatsapp_number']; ?>" onkeypress="return isNumberKey(event)" onInput="checkLength(12,this)" onblur="getChassis(this.value)"></td>
    </tr>
    <tr>
    	<th align="left">Email</th>
        <td><input type="text" name="email" id="email" size="50" value="<?php echo $rs['email']; ?>"></td>
    </tr>
    <tr>
    	<th align="left">Website</th>
        <td><input type="text" name="website" id="website" size="50" value="<?php echo $rs['website']; ?>"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="commission_percentage" id="commission_percentage" value="<?php echo $rs['commission_percentage']; ?>" size="5" onkeypress="return isNumberKey(event)" onInput="checkLength(6,this)" onblur="getChassis(this.value)"></td>
    </tr>
	
	<?php }else{ ?>
		<input type="hidden" name="commission_percentage" id="commission_percentage" value="<?php echo $rs['commission_percentage']; ?>" >
	<?php } ?>		
	<tr>
	...
	<?php }else{ ?>
		<input type='hidden' name="agent_id" id="agent_id" value='<?php echo $a_rs['company_id'];?>'>

	<?php } ?>

    <tr>
    	<th align="left">Reference</th>
        <td><input name="reference" type="text" id="reference" value="<?php echo $rs['reference']; ?>" size="40"></td>
    </tr>
    <tr>
    	<th align="left">Remarks</th>
        <td><input name="remarks" type="text" id="remarks" value="<?php echo $rs['remarks']; ?>" size="40"></td>
    </tr>
    <tr>
    	<th align="left">PAN Number</th>
        <td><input type="text" name="pan_number" id="pan_number" size="10" value="<?php echo $rs['pan_number']; ?>"></td>
	</tr>
    <tr>
    	<th align="left">Products</th>
        <td><input type="text" name="products" id="products" size="80" value="<?php echo $rs['products']; ?>"></td>
	</tr>
    <tr>
    	<th align="left">Brands</th>
        <td><input type="text" name="brands" id="brands" size="80" value="<?php echo $rs['brands']; ?>"></td>
	</tr>	
    ...
    <tr>
        ...
        if($rs['visiting_card']!="") { ?>
            ...
            &nbsp;&nbsp;<a href="process_company.php?action=remfile&ft=visiting_card&company_id=<?php echo $rs['company_id']; ?>" onclick="return confirmDelete()">Remove File</a><?php } else { ?>
				<img src="../images/upload_2.png" alt="no image" id="prev0" style="width:25px;height:25px;" name="prev_img1[]" />
        <input type="file" name="visiting_card" id="visiting_card"> <?php } ?>
        </td>
    </tr>
    <tr>
        ...
        if($rs['photo_1']!="") { ?>
            ...
            &nbsp;&nbsp;<a href="process_company.php?action=remfile&ft=photo_1&company_id=<?php echo $rs['company_id']; ?>" onclick="return confirmDelete()">Remove File</a><?php } else { ?>
				<img src="../images/upload_2.png" alt="no image" id="prev0" style="width:25px;height:25px;" name="prev_img1[]" />
        <input type="file" name="photo_1" id="photo_1"> <?php } ?>
        </td>
    </tr>
    <tr>
        ...
        if($rs['photo_2']!="") { ?>
            ...
            &nbsp;&nbsp;<a href="process_company.php?action=remfile&ft=photo_2&company_id=<?php echo $rs['company_id']; ?>" onclick="return confirmDelete()">Remove File</a><?php } else { ?>
				<img src="../images/upload_2.png" alt="no image" id="prev0" style="width:25px;height:25px;" name="prev_img1[]" />
        <input type="file" name="photo_2" id="photo_2"> <?php } ?>
        </td>
    </tr>
    </table>
     <br /><br />
