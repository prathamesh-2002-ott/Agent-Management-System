...
$sql_pay.= " ORDER by supp_firm_name,buy_firm_name,bill_date,bill_number ) AS t1
        LEFT JOIN 
        ...
        ON t1.bill_entry_id=t2.t2_bill_entry_id 
         ORDER by supp_firm_name,buy_firm_name,bill_date,bill_number ";
...
<tr>
    <th colspan='<?php echo $col_span*2;?>'> Supplier Outstanding by Group </th>
      </tr>
      <tr>
