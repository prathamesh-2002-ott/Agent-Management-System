...
$sql_pay.= " ORDER by buy_firm_name,supp_firm_name,bill_date ,bill_number) AS t1
        ...
        ON t1.bill_entry_id=t2.t2_bill_entry_id  ORDER BY  buy_firm_name,supp_firm_name,bill_date ,bill_number";
...
<tr>
    <th colspan='<?php echo $col_span*2;?>'> Buyer Outstanding by Group </th>
      </tr>
      <tr>
...
<?php   
        ...
        if(($rs['supplier_account_code']!=$old_supplier_code && $old_bill_entry_id!=0) || $buyer_header=="NEW"){
          echo "<tr> <td  colspan='".($col_span*2)."' align='left' ><b>&nbsp;&nbsp;&nbsp;&nbsp; Supplier  :-&nbsp;&nbsp;".trim($rs['supp_firm_name'])."</b></td> 
          </tr>";
          $s_no=1;
          */
        } 
