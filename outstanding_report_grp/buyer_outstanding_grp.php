...
<title>Buyer Outstanding Report</title>
...
function check(){
  ...
  function report_submit(){
    //if(check()){
      document.getElementById('report').action='buyer_outstanding_grp.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
          //buyer_outstanding_grp_report_dispaly_xls
        document.getElementById('report').action='buyer_outstanding_grp_report_display_xls.php';
        document.getElementById('report').target="_self";
        document.getElementById('report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('report').action='buyer_outstanding_grp_report_display_print.php';
...
if(isset($_REQUEST['buyer_group_code'])){
  $buyer_code=$_REQUEST['buyer_group_code'];
}
...
<table width="100%"  align="center" style="border:1px solid #e5f1f8;background-color:#FFFFFF">
  ...
  <tr>
    <td height="326" valign="top">
          ...
          <td valign="top">
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr><td><h3>Buyer Group Outstanding :</h3></td></tr></table>
              </div>
      ...
      <td>
          <select  onchange='downloadLock()' name="buyer_group_code" id="buyer_group_code">
              <option value="">All</option>
                ...
                <tr><td colspan='4'> <span class="astrik">*</span> Report will be displayed in order of Buyer <b> Grouped by Supplier </b></td></tr>
              ...
              <?php   if(isset($_REQUEST['report_disp'])){
                if($_REQUEST['report_disp']=='OK'){
                  $rep_print="" ; $rep_xls="" ; $download=''; ?>           
              <?php include("buyer_outstanding_grp_report_display.php"); ?>   
              <?php } }?>           
            </div>                                 
          </td>
        </tr>
