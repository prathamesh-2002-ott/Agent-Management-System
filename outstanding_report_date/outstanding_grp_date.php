...
<title>Outstanding Report Group (DW)</title>
...
function check(){
  ...
  function report_submit(){
    //if(check()){
      document.getElementById('report').action='outstanding_grp_date.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        ...
        document.getElementById('report').action='outstanding_grp_date_report_display_xls.php';
        document.getElementById('report').target="_self";
        document.getElementById('report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('report').action='outstanding_grp_date_report_display_print.php';
          ...
          <td valign="top">
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr><td><h3>Group Outstanding (Date Wise) :</h3></td></tr></table>
              </div>
