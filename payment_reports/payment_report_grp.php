...
<script>
  function report_submit(){
    document.getElementById('report').action='payment_report_grp.php';
  ...
  function excelDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
      document.getElementById('report').action='payment_report_display_xls.php';
      document.getElementById('report').target="_self";
      document.getElementById('report').submit();
    }else{
  ...
  function pdfDownLoad(){
    if(document.getElementById('download_lock').value=='OFF'){    
        document.getElementById('report').action='payment_report_display_print.php';
...
$report_disp="";
if(isset($_REQUEST['report_disp'])){
$report_disp=$_REQUEST['report_disp'];
}
          ...
          <td valign="top">
            <div class="content_padding">
              <div class="content-header">
                <table width="100%" border='0'><tr><td><h3>Payment & GR Report :</h3></td></tr></table>
              </div>
              ...
              <input type='hidden' name='report_type' id='report_type' value='GROUP' >
              <br>
              <br>
              </form>
              <?php if(isset($_REQUEST['report_disp']))  {
                  if($_REQUEST['report_disp']=='OK'){  $rep_print="" ; $rep_xls="" ; $download='';  ?>           
              <?php include("payment_report_display.php"); ?>   
              <?php } } ?>           
            </div>                                 
          </td>
        </tr>
